CREATE DATABASE IF NOT EXISTS bdu05_jardineria
CHARACTER SET utf8mb4 COLLATE utf8mb4_es_0900_ai_ci;
USE bdu05_jardineria;
...
CREATE TABLE oficinas (
  ...
  lin_direccion1  VARCHAR(50) NOT NULL,
  lin_direccion2  VARCHAR(50)
);
...
CREATE TABLE empleados (
  ...
  CONSTRAINT emp_ofi_fk FOREIGN KEY (cod_oficina) REFERENCES oficinas (cod_oficina),
  CONSTRAINT emp_jef_fk FOREIGN KEY (cod_jefe) REFERENCES empleados (cod_empleado)
);
...
CREATE TABLE clientes (
  ...
  CONSTRAINT cli_rep_fk FOREIGN KEY (representante) REFERENCES empleados (cod_empleado)
);
...
INSERT INTO gamas VALUES ('Herbaceas','Plantas para jardin decorativas',NULL,NULL);
INSERT INTO gamas VALUES ('Herramientas','Herramientas para todo tipo de acción',NULL,NULL);
INSERT INTO gamas VALUES ('Aromáticas','Plantas aromáticas',NULL,NULL);
INSERT INTO gamas VALUES ('Frutales','Árboles pequeños de producción frutal',NULL,NULL);
INSERT INTO gamas VALUES ('Ornamentales','Plantas vistosas para la decoración del jardín',NULL,NULL);
...
CREATE TABLE productos (
  ...
  descripcion     TEXT,
  cantstock       SMALLINT NOT NULL,
  precio_venta    DECIMAL(15,2) NOT NULL,
  precio_prov     DECIMAL(15,2),
  PRIMARY KEY (cod_producto),
  CONSTRAINT pro_gam_fk FOREIGN KEY (gama) REFERENCES gamas (gama)
);
...
CREATE TABLE pedidos (
  ...
  fec_esperada  DATE NOT NULL,
  fec_entrega   DATE,
  estado        VARCHAR(15) NOT NULL,
  comentarios   TEXT,
  cod_cliente   INTEGER NOT NULL,
  PRIMARY KEY (cod_pedido),
  CONSTRAINT ped_cli_fk FOREIGN KEY (cod_cliente) REFERENCES clientes (cod_cliente)
);
...
CREATE TABLE detalle_pedidos (
  ...
  CONSTRAINT det_ped_fk FOREIGN KEY (cod_pedido) REFERENCES pedidos (cod_pedido),
  CONSTRAINT det_pro_fk FOREIGN KEY (cod_producto) REFERENCES productos (cod_producto)
);

INSERT INTO detalle_pedidos VALUES (1,'FR-67',10,70,3);
INSERT INTO detalle_pedidos VALUES (1,'OR-127',40,4,1);
INSERT INTO detalle_pedidos VALUES (1,'OR-141',25,4,2);
INSERT INTO detalle_pedidos VALUES (1,'OR-241',15,19,4);
INSERT INTO detalle_pedidos VALUES (1,'OR-99',23,14,5);
INSERT INTO detalle_pedidos VALUES (2,'FR-4',3,29,6);
INSERT INTO detalle_pedidos VALUES (2,'FR-40',7,8,7);
INSERT INTO detalle_pedidos VALUES (2,'OR-140',50,4,3);
INSERT INTO detalle_pedidos VALUES (2,'OR-141',20,5,2);
INSERT INTO detalle_pedidos VALUES (2,'OR-159',12,6,5);
INSERT INTO detalle_pedidos VALUES (2,'OR-227',67,64,1);
INSERT INTO detalle_pedidos VALUES (2,'OR-247',5,462,4);
INSERT INTO detalle_pedidos VALUES (3,'FR-48',120,9,6);
INSERT INTO detalle_pedidos VALUES (3,'OR-122',32,5,4);
INSERT INTO detalle_pedidos VALUES (3,'OR-123',11,5,5);
INSERT INTO detalle_pedidos VALUES (3,'OR-213',30,266,1);
INSERT INTO detalle_pedidos VALUES (3,'OR-217',15,65,2);
INSERT INTO detalle_pedidos VALUES (3,'OR-218',24,25,3);
INSERT INTO detalle_pedidos VALUES (4,'FR-31',12,8,7);
INSERT INTO detalle_pedidos VALUES (4,'FR-34',42,8,6);
INSERT INTO detalle_pedidos VALUES (4,'FR-40',42,9,8);
INSERT INTO detalle_pedidos VALUES (4,'OR-152',3,6,5);
INSERT INTO detalle_pedidos VALUES (4,'OR-155',4,6,3);
INSERT INTO detalle_pedidos VALUES (4,'OR-156',17,9,4);
INSERT INTO detalle_pedidos VALUES (4,'OR-157',38,10,2);
INSERT INTO detalle_pedidos VALUES (4,'OR-222',21,59,1);
INSERT INTO detalle_pedidos VALUES (8,'FR-106',3,11,1);
INSERT INTO detalle_pedidos VALUES (8,'FR-108',1,32,2);
INSERT INTO detalle_pedidos VALUES (8,'FR-11',10,100,3);
INSERT INTO detalle_pedidos VALUES (9,'AR-001',80,1,3);
INSERT INTO detalle_pedidos VALUES (9,'AR-008',450,1,2);
INSERT INTO detalle_pedidos VALUES (9,'FR-106',80,8,1);
INSERT INTO detalle_pedidos VALUES (9,'FR-69',15,91,2);
INSERT INTO detalle_pedidos VALUES (10,'FR-82',5,70,2);
INSERT INTO detalle_pedidos VALUES (10,'FR-91',30,75,1);
INSERT INTO detalle_pedidos VALUES (10,'OR-234',5,64,3);
INSERT INTO detalle_pedidos VALUES (11,'AR-006',180,1,3);
INSERT INTO detalle_pedidos VALUES (11,'OR-247',80,8,1);
INSERT INTO detalle_pedidos VALUES (12,'AR-009',290,1,1);
INSERT INTO detalle_pedidos VALUES (13,'11679',5,14,1);
INSERT INTO detalle_pedidos VALUES (13,'21636',12,14,2);
INSERT INTO detalle_pedidos VALUES (13,'FR-11',5,100,3);
INSERT INTO detalle_pedidos VALUES (14,'FR-100',8,11,2);
INSERT INTO detalle_pedidos VALUES (14,'FR-13',13,57,1);
INSERT INTO detalle_pedidos VALUES (15,'FR-84',4,13,3);
INSERT INTO detalle_pedidos VALUES (15,'OR-101',2,6,2);
INSERT INTO detalle_pedidos VALUES (15,'OR-156',6,10,1);
INSERT INTO detalle_pedidos VALUES (15,'OR-203',9,10,4);
INSERT INTO detalle_pedidos VALUES (16,'30310',12,12,1);
INSERT INTO detalle_pedidos VALUES (16,'FR-36',10,9,2);
INSERT INTO detalle_pedidos VALUES (17,'11679',5,14,1);
INSERT INTO detalle_pedidos VALUES (17,'22225',5,12,3);
INSERT INTO detalle_pedidos VALUES (17,'FR-37',5,9,2);
INSERT INTO detalle_pedidos VALUES (17,'FR-64',5,22,4);
INSERT INTO detalle_pedidos VALUES (17,'OR-136',5,18,5);
INSERT INTO detalle_pedidos VALUES (18,'22225',4,12,2);
INSERT INTO detalle_pedidos VALUES (18,'FR-22',2,4,1);
INSERT INTO detalle_pedidos VALUES (18,'OR-159',10,6,3);
INSERT INTO detalle_pedidos VALUES (19,'30310',9,12,5);
INSERT INTO detalle_pedidos VALUES (19,'FR-23',6,8,4);
INSERT INTO detalle_pedidos VALUES (19,'FR-75',1,32,2);
INSERT INTO detalle_pedidos VALUES (19,'FR-84',5,13,1);
INSERT INTO detalle_pedidos VALUES (19,'OR-208',20,4,3);
INSERT INTO detalle_pedidos VALUES (20,'11679',14,14,1);
INSERT INTO detalle_pedidos VALUES (20,'30310',8,12,2);
INSERT INTO detalle_pedidos VALUES (21,'21636',5,14,3);
INSERT INTO detalle_pedidos VALUES (21,'FR-18',22,4,1);
INSERT INTO detalle_pedidos VALUES (21,'FR-53',3,8,2);
INSERT INTO detalle_pedidos VALUES (22,'OR-240',1,6,1);
INSERT INTO detalle_pedidos VALUES (23,'AR-002',110,1,4);
INSERT INTO detalle_pedidos VALUES (23,'FR-107',50,22,3);
INSERT INTO detalle_pedidos VALUES (23,'FR-85',4,70,2);
INSERT INTO detalle_pedidos VALUES (23,'OR-249',30,5,1);
INSERT INTO detalle_pedidos VALUES (24,'22225',3,15,1);
INSERT INTO detalle_pedidos VALUES (24,'FR-1',4,7,4);
INSERT INTO detalle_pedidos VALUES (24,'FR-23',2,7,2);
INSERT INTO detalle_pedidos VALUES (24,'OR-241',10,20,3);
INSERT INTO detalle_pedidos VALUES (25,'FR-77',15,69,1);
INSERT INTO detalle_pedidos VALUES (25,'FR-9',4,30,3);
INSERT INTO detalle_pedidos VALUES (25,'FR-94',10,30,2);
INSERT INTO detalle_pedidos VALUES (26,'FR-15',9,25,3);
INSERT INTO detalle_pedidos VALUES (26,'OR-188',4,25,1);
INSERT INTO detalle_pedidos VALUES (26,'OR-218',14,25,2);
INSERT INTO detalle_pedidos VALUES (27,'OR-101',22,6,2);
INSERT INTO detalle_pedidos VALUES (27,'OR-102',22,6,3);
INSERT INTO detalle_pedidos VALUES (27,'OR-186',40,6,1);
INSERT INTO detalle_pedidos VALUES (28,'FR-11',8,99,3);
INSERT INTO detalle_pedidos VALUES (28,'OR-213',3,266,2);
INSERT INTO detalle_pedidos VALUES (28,'OR-247',1,462,1);
INSERT INTO detalle_pedidos VALUES (29,'FR-82',4,70,4);
INSERT INTO detalle_pedidos VALUES (29,'FR-9',4,28,1);
INSERT INTO detalle_pedidos VALUES (29,'FR-94',20,31,5);
INSERT INTO detalle_pedidos VALUES (29,'OR-129',2,111,2);
INSERT INTO detalle_pedidos VALUES (29,'OR-160',10,9,3);
INSERT INTO detalle_pedidos VALUES (30,'AR-004',10,1,6);
INSERT INTO detalle_pedidos VALUES (30,'FR-108',2,32,2);
INSERT INTO detalle_pedidos VALUES (30,'FR-12',2,19,3);
INSERT INTO detalle_pedidos VALUES (30,'FR-72',4,31,5);
INSERT INTO detalle_pedidos VALUES (30,'FR-89',10,45,1);
INSERT INTO detalle_pedidos VALUES (30,'OR-120',5,5,4);
INSERT INTO detalle_pedidos VALUES (31,'AR-009',25,2,3);
INSERT INTO detalle_pedidos VALUES (31,'FR-102',1,20,1);
INSERT INTO detalle_pedidos VALUES (31,'FR-4',6,29,2);
INSERT INTO detalle_pedidos VALUES (32,'11679',1,14,4);
INSERT INTO detalle_pedidos VALUES (32,'21636',4,15,5);
INSERT INTO detalle_pedidos VALUES (32,'22225',1,15,3);
INSERT INTO detalle_pedidos VALUES (32,'OR-128',29,100,2);
INSERT INTO detalle_pedidos VALUES (32,'OR-193',5,20,1);
INSERT INTO detalle_pedidos VALUES (33,'FR-17',423,2,4);
INSERT INTO detalle_pedidos VALUES (33,'FR-29',120,8,3);
INSERT INTO detalle_pedidos VALUES (33,'OR-214',212,10,2);
INSERT INTO detalle_pedidos VALUES (33,'OR-247',150,462,1);
INSERT INTO detalle_pedidos VALUES (34,'FR-3',56,7,4);
INSERT INTO detalle_pedidos VALUES (34,'FR-7',12,29,3);
INSERT INTO detalle_pedidos VALUES (34,'OR-172',20,18,1);
INSERT INTO detalle_pedidos VALUES (34,'OR-174',24,18,2);
INSERT INTO detalle_pedidos VALUES (35,'21636',12,14,4);
INSERT INTO detalle_pedidos VALUES (35,'FR-47',55,8,3);
INSERT INTO detalle_pedidos VALUES (35,'OR-165',3,10,2);
INSERT INTO detalle_pedidos VALUES (35,'OR-181',36,10,1);
INSERT INTO detalle_pedidos VALUES (35,'OR-225',72,10,5);
INSERT INTO detalle_pedidos VALUES (36,'30310',4,12,2);
INSERT INTO detalle_pedidos VALUES (36,'FR-1',2,7,3);
INSERT INTO detalle_pedidos VALUES (36,'OR-147',6,7,4);
INSERT INTO detalle_pedidos VALUES (36,'OR-203',1,12,5);
INSERT INTO detalle_pedidos VALUES (36,'OR-99',15,13,1);
INSERT INTO detalle_pedidos VALUES (37,'FR-105',4,70,1);
INSERT INTO detalle_pedidos VALUES (37,'FR-57',203,8,2);
INSERT INTO detalle_pedidos VALUES (37,'OR-176',38,10,3);
INSERT INTO detalle_pedidos VALUES (38,'11679',5,14,1);
INSERT INTO detalle_pedidos VALUES (38,'21636',2,14,2);
INSERT INTO detalle_pedidos VALUES (39,'22225',3,12,1);
INSERT INTO detalle_pedidos VALUES (39,'30310',6,12,2);
INSERT INTO detalle_pedidos VALUES (40,'AR-001',4,1,1);
INSERT INTO detalle_pedidos VALUES (40,'AR-002',8,1,2);
INSERT INTO detalle_pedidos VALUES (41,'AR-003',5,1,1);
INSERT INTO detalle_pedidos VALUES (41,'AR-004',5,1,2);
INSERT INTO detalle_pedidos VALUES (42,'AR-005',3,1,1);
INSERT INTO detalle_pedidos VALUES (42,'AR-006',1,1,2);
INSERT INTO detalle_pedidos VALUES (43,'AR-007',9,1,1);
INSERT INTO detalle_pedidos VALUES (44,'AR-008',5,1,1);
INSERT INTO detalle_pedidos VALUES (45,'AR-009',6,1,1);
INSERT INTO detalle_pedidos VALUES (45,'AR-010',4,1,2);
INSERT INTO detalle_pedidos VALUES (46,'FR-1',4,7,1);
INSERT INTO detalle_pedidos VALUES (46,'FR-10',8,7,2);
INSERT INTO detalle_pedidos VALUES (47,'FR-100',9,11,1);
INSERT INTO detalle_pedidos VALUES (47,'FR-101',5,13,2);
INSERT INTO detalle_pedidos VALUES (48,'FR-102',1,18,1);
INSERT INTO detalle_pedidos VALUES (48,'FR-103',1,25,2);
INSERT INTO detalle_pedidos VALUES (48,'OR-234',50,64,1);
INSERT INTO detalle_pedidos VALUES (48,'OR-236',45,49,2);
INSERT INTO detalle_pedidos VALUES (48,'OR-237',50,19,3);
INSERT INTO detalle_pedidos VALUES (49,'OR-204',50,10,1);
INSERT INTO detalle_pedidos VALUES (49,'OR-205',10,10,2);
INSERT INTO detalle_pedidos VALUES (49,'OR-206',5,5,3);
INSERT INTO detalle_pedidos VALUES (50,'OR-225',12,10,1);
INSERT INTO detalle_pedidos VALUES (50,'OR-226',15,38,2);
INSERT INTO detalle_pedidos VALUES (50,'OR-227',44,64,3);
INSERT INTO detalle_pedidos VALUES (51,'OR-209',50,10,1);
INSERT INTO detalle_pedidos VALUES (51,'OR-210',80,39,2);
INSERT INTO detalle_pedidos VALUES (51,'OR-211',70,59,3);
INSERT INTO detalle_pedidos VALUES (53,'FR-2',1,7,1);
INSERT INTO detalle_pedidos VALUES (53,'FR-85',1,70,3);
INSERT INTO detalle_pedidos VALUES (53,'FR-86',2,11,2);
INSERT INTO detalle_pedidos VALUES (53,'OR-116',6,7,4);
INSERT INTO detalle_pedidos VALUES (54,'11679',3,14,3);
INSERT INTO detalle_pedidos VALUES (54,'FR-100',45,10,2);
INSERT INTO detalle_pedidos VALUES (54,'FR-18',5,4,1);
INSERT INTO detalle_pedidos VALUES (54,'FR-79',3,22,4);
INSERT INTO detalle_pedidos VALUES (54,'OR-116',8,7,6);
INSERT INTO detalle_pedidos VALUES (54,'OR-123',3,5,5);
INSERT INTO detalle_pedidos VALUES (54,'OR-168',2,10,7);
INSERT INTO detalle_pedidos VALUES (55,'OR-115',9,7,1);
INSERT INTO detalle_pedidos VALUES (55,'OR-213',2,266,2);
INSERT INTO detalle_pedidos VALUES (55,'OR-227',6,64,5);
INSERT INTO detalle_pedidos VALUES (55,'OR-243',2,64,4);
INSERT INTO detalle_pedidos VALUES (55,'OR-247',1,462,3);
INSERT INTO detalle_pedidos VALUES (56,'OR-129',1,115,5);
INSERT INTO detalle_pedidos VALUES (56,'OR-130',10,18,6);
INSERT INTO detalle_pedidos VALUES (56,'OR-179',1,6,3);
INSERT INTO detalle_pedidos VALUES (56,'OR-196',3,10,4);
INSERT INTO detalle_pedidos VALUES (56,'OR-207',4,4,2);
INSERT INTO detalle_pedidos VALUES (56,'OR-250',3,10,1);
INSERT INTO detalle_pedidos VALUES (57,'FR-69',6,91,4);
INSERT INTO detalle_pedidos VALUES (57,'FR-81',3,49,3);
INSERT INTO detalle_pedidos VALUES (57,'FR-84',2,13,1);
INSERT INTO detalle_pedidos VALUES (57,'FR-94',6,9,2);
INSERT INTO detalle_pedidos VALUES (58,'OR-102',65,18,3);
INSERT INTO detalle_pedidos VALUES (58,'OR-139',80,4,1);
INSERT INTO detalle_pedidos VALUES (58,'OR-172',69,15,2);
INSERT INTO detalle_pedidos VALUES (58,'OR-177',150,15,4);
INSERT INTO detalle_pedidos VALUES (74,'FR-67',15,70,1);
INSERT INTO detalle_pedidos VALUES (74,'OR-227',34,64,2);
INSERT INTO detalle_pedidos VALUES (74,'OR-247',42,8,3);
INSERT INTO detalle_pedidos VALUES (75,'AR-006',60,1,2);
INSERT INTO detalle_pedidos VALUES (75,'FR-87',24,22,3);
INSERT INTO detalle_pedidos VALUES (75,'OR-157',46,10,1);
INSERT INTO detalle_pedidos VALUES (76,'AR-009',250,1,5);
INSERT INTO detalle_pedidos VALUES (76,'FR-79',40,22,3);
INSERT INTO detalle_pedidos VALUES (76,'FR-87',24,22,4);
INSERT INTO detalle_pedidos VALUES (76,'FR-94',35,9,1);
INSERT INTO detalle_pedidos VALUES (76,'OR-196',25,10,2);
INSERT INTO detalle_pedidos VALUES (77,'22225',34,12,2);
INSERT INTO detalle_pedidos VALUES (77,'30310',15,12,1);
INSERT INTO detalle_pedidos VALUES (78,'FR-53',25,8,2);
INSERT INTO detalle_pedidos VALUES (78,'FR-85',56,70,3);
INSERT INTO detalle_pedidos VALUES (78,'OR-157',42,10,4);
INSERT INTO detalle_pedidos VALUES (78,'OR-208',30,4,1);
INSERT INTO detalle_pedidos VALUES (79,'OR-240',50,6,1);
INSERT INTO detalle_pedidos VALUES (80,'FR-11',40,100,3);
INSERT INTO detalle_pedidos VALUES (80,'FR-36',47,9,2);
INSERT INTO detalle_pedidos VALUES (80,'OR-136',75,18,1);
INSERT INTO detalle_pedidos VALUES (81,'OR-208',30,4,1);
INSERT INTO detalle_pedidos VALUES (82,'OR-227',34,64,1);
INSERT INTO detalle_pedidos VALUES (83,'OR-208',30,4,1);
INSERT INTO detalle_pedidos VALUES (89,'FR-108',3,32,2);
INSERT INTO detalle_pedidos VALUES (89,'FR-3',15,7,6);
INSERT INTO detalle_pedidos VALUES (89,'FR-42',12,8,4);
INSERT INTO detalle_pedidos VALUES (89,'FR-66',5,49,1);
INSERT INTO detalle_pedidos VALUES (89,'FR-87',4,22,3);
INSERT INTO detalle_pedidos VALUES (89,'OR-157',8,10,5);
INSERT INTO detalle_pedidos VALUES (90,'AR-001',19,1,1);
INSERT INTO detalle_pedidos VALUES (90,'AR-002',10,1,2);
INSERT INTO detalle_pedidos VALUES (90,'AR-003',12,1,3);
INSERT INTO detalle_pedidos VALUES (91,'FR-100',52,11,1);
INSERT INTO detalle_pedidos VALUES (91,'FR-101',14,13,2);
INSERT INTO detalle_pedidos VALUES (91,'FR-102',35,18,3);
INSERT INTO detalle_pedidos VALUES (92,'FR-108',12,23,1);
INSERT INTO detalle_pedidos VALUES (92,'FR-11',20,100,2);
INSERT INTO detalle_pedidos VALUES (92,'FR-12',30,21,3);
INSERT INTO detalle_pedidos VALUES (93,'FR-54',25,9,1);
INSERT INTO detalle_pedidos VALUES (93,'FR-58',51,11,2);
INSERT INTO detalle_pedidos VALUES (93,'FR-60',3,32,3);
INSERT INTO detalle_pedidos VALUES (94,'11679',12,14,1);
INSERT INTO detalle_pedidos VALUES (94,'FR-11',33,100,3);
INSERT INTO detalle_pedidos VALUES (94,'FR-4',79,29,2);
INSERT INTO detalle_pedidos VALUES (95,'FR-10',9,7,2);
INSERT INTO detalle_pedidos VALUES (95,'FR-75',6,32,1);
INSERT INTO detalle_pedidos VALUES (95,'FR-82',5,70,3);
INSERT INTO detalle_pedidos VALUES (96,'FR-43',6,8,1);
INSERT INTO detalle_pedidos VALUES (96,'FR-6',16,7,4);
INSERT INTO detalle_pedidos VALUES (96,'FR-71',10,22,3);
INSERT INTO detalle_pedidos VALUES (96,'FR-90',4,70,2);
INSERT INTO detalle_pedidos VALUES (97,'FR-41',12,8,1);
INSERT INTO detalle_pedidos VALUES (97,'FR-54',14,9,2);
INSERT INTO detalle_pedidos VALUES (97,'OR-156',10,10,3);
INSERT INTO detalle_pedidos VALUES (98,'FR-33',14,8,4);
INSERT INTO detalle_pedidos VALUES (98,'FR-56',16,8,3);
INSERT INTO detalle_pedidos VALUES (98,'FR-60',8,32,1);
INSERT INTO detalle_pedidos VALUES (98,'FR-8',18,6,5);
INSERT INTO detalle_pedidos VALUES (98,'FR-85',6,70,2);
INSERT INTO detalle_pedidos VALUES (99,'OR-157',15,10,2);
INSERT INTO detalle_pedidos VALUES (99,'OR-227',30,64,1);
INSERT INTO detalle_pedidos VALUES (100,'FR-87',20,22,1);
INSERT INTO detalle_pedidos VALUES (100,'FR-94',40,9,2);
INSERT INTO detalle_pedidos VALUES (101,'AR-006',50,1,1);
INSERT INTO detalle_pedidos VALUES (101,'AR-009',159,1,2);
INSERT INTO detalle_pedidos VALUES (102,'22225',32,12,2);
INSERT INTO detalle_pedidos VALUES (102,'30310',23,12,1);
INSERT INTO detalle_pedidos VALUES (103,'FR-53',12,8,2);
INSERT INTO detalle_pedidos VALUES (103,'OR-208',52,4,1);
INSERT INTO detalle_pedidos VALUES (104,'FR-85',9,70,1);
INSERT INTO detalle_pedidos VALUES (104,'OR-157',113,10,2);
INSERT INTO detalle_pedidos VALUES (105,'OR-227',21,64,2);
INSERT INTO detalle_pedidos VALUES (105,'OR-240',27,6,1);
INSERT INTO detalle_pedidos VALUES (106,'AR-009',231,1,1);
INSERT INTO detalle_pedidos VALUES (106,'OR-136',47,18,2);
INSERT INTO detalle_pedidos VALUES (107,'30310',143,12,2);
INSERT INTO detalle_pedidos VALUES (107,'FR-11',15,100,1);
INSERT INTO detalle_pedidos VALUES (108,'FR-53',53,8,1);
INSERT INTO detalle_pedidos VALUES (108,'OR-208',59,4,2);
INSERT INTO detalle_pedidos VALUES (109,'FR-22',8,4,5);
INSERT INTO detalle_pedidos VALUES (109,'FR-36',12,9,3);
INSERT INTO detalle_pedidos VALUES (109,'FR-45',14,8,4);
INSERT INTO detalle_pedidos VALUES (109,'OR-104',20,10,1);
INSERT INTO detalle_pedidos VALUES (109,'OR-119',10,5,2);
INSERT INTO detalle_pedidos VALUES (109,'OR-125',3,5,6);
INSERT INTO detalle_pedidos VALUES (109,'OR-130',2,18,7);
INSERT INTO detalle_pedidos VALUES (110,'AR-010',6,1,3);
INSERT INTO detalle_pedidos VALUES (110,'FR-1',14,7,1);
INSERT INTO detalle_pedidos VALUES (110,'FR-16',1,45,2);
INSERT INTO detalle_pedidos VALUES (116,'21636',5,14,1);
INSERT INTO detalle_pedidos VALUES (116,'AR-001',32,1,2);
INSERT INTO detalle_pedidos VALUES (116,'AR-005',18,1,5);
INSERT INTO detalle_pedidos VALUES (116,'FR-33',13,8,3);
INSERT INTO detalle_pedidos VALUES (116,'OR-200',10,4,4);
INSERT INTO detalle_pedidos VALUES (117,'FR-78',2,15,1);
INSERT INTO detalle_pedidos VALUES (117,'FR-80',1,32,3);
INSERT INTO detalle_pedidos VALUES (117,'OR-146',17,4,2);
INSERT INTO detalle_pedidos VALUES (117,'OR-179',4,6,4);
INSERT INTO detalle_pedidos VALUES (128,'AR-004',15,1,1);
INSERT INTO detalle_pedidos VALUES (128,'OR-150',18,2,2);
...
CREATE TABLE pagos (
  ...
  PRIMARY KEY (cod_cliente,id_transaccion),
  CONSTRAINT pag_cli_fk FOREIGN KEY (cod_cliente) REFERENCES clientes (cod_cliente)
);

INSERT INTO pagos VALUES (1,'ak-std-000001','PayPal','2008-11-10',2000);
INSERT INTO pagos VALUES (1,'ak-std-000002','PayPal','2008-12-10',2000);
INSERT INTO pagos VALUES (3,'ak-std-000003','PayPal','2009-01-16',5000);
INSERT INTO pagos VALUES (3,'ak-std-000004','PayPal','2009-02-16',5000);
INSERT INTO pagos VALUES (3,'ak-std-000005','PayPal','2009-02-19',926);
INSERT INTO pagos VALUES (4,'ak-std-000006','PayPal','2007-01-08',20000);
INSERT INTO pagos VALUES (4,'ak-std-000007','PayPal','2007-01-08',20000);
INSERT INTO pagos VALUES (4,'ak-std-000008','PayPal','2007-01-08',20000);
INSERT INTO pagos VALUES (4,'ak-std-000009','PayPal','2007-01-08',20000);
INSERT INTO pagos VALUES (4,'ak-std-000010','PayPal','2007-01-08',1849);
INSERT INTO pagos VALUES (5,'ak-std-000011','Transferencia','2006-01-18',23794);
INSERT INTO pagos VALUES (7,'ak-std-000012','Cheque','2009-01-13',2390);
INSERT INTO pagos VALUES (9,'ak-std-000013','PayPal','2009-01-06',929);
INSERT INTO pagos VALUES (13,'ak-std-000014','PayPal','2008-08-04',2246);
INSERT INTO pagos VALUES (14,'ak-std-000015','PayPal','2008-07-15',4160);
INSERT INTO pagos VALUES (15,'ak-std-000016','PayPal','2009-01-15',2081);
INSERT INTO pagos VALUES (15,'ak-std-000035','PayPal','2009-02-15',10000);
INSERT INTO pagos VALUES (16,'ak-std-000017','PayPal','2009-02-16',4399);
INSERT INTO pagos VALUES (19,'ak-std-000018','PayPal','2009-03-06',232);
INSERT INTO pagos VALUES (23,'ak-std-000019','PayPal','2009-03-26',272);
INSERT INTO pagos VALUES (26,'ak-std-000020','PayPal','2008-03-18',18846);
INSERT INTO pagos VALUES (27,'ak-std-000021','PayPal','2009-02-08',10972);
INSERT INTO pagos VALUES (28,'ak-std-000022','PayPal','2009-01-13',8489);
INSERT INTO pagos VALUES (30,'ak-std-000024','PayPal','2009-01-16',7863);
INSERT INTO pagos VALUES (35,'ak-std-000025','PayPal','2007-10-06',3321);
INSERT INTO pagos VALUES (38,'ak-std-000026','PayPal','2006-05-26',1171);

-- 2.1 Consulta 1
-- Mostrar el número de clientes que tenemos en cada ciudad en una columna denominada "Num_de_Clientes", ordenado por el número de clientes 
-- de mayor a menor. Recordad que no debemos ordenar nunca por el alias de la columna, sino por la expresión o función agregada.
...
-- 2.3. Consulta 3
-- Mostrar el número de clientes que tenemos en cada ciudad de España con más de un cliente en una columna denominada "Num_de_Clientes",
-- ordenado de mayor a menor por el número de clientes.
use bdu05_jardineria;

select * FROM clientes
where pais in ("éspaña","Spain")
group by ciudad
having count(*)>1
order by 2 desc;

-- 2.4. Consulta 4
-- Mostrar cuál es el beneficio máximo que se puede obtener con la venta de un producto de los que tenemos en stock en cada una de las gamas
-- que tenemos. Ordena el resultado por el beneficio de mayor a menor.

select* from productos;
select gama,MAX(precio_venta-precio_prov) as beneficio
from productos
where cantstock >0
group by gama;

-- 2.5. Consulta 5
-- Obtener cuántos pedidos ha realizado cada cliente, ordenado por el número
-- de pedidos, de mayor a menor número de pedidos.
select * from pedidos;

select cod_cliente, COUNT(*) AS Num_total_pedidos
from pedidos
group by cod_cliente
order by 2 desc;

-- 2.6. Consulta 6
-- Mostrar cuántos pedidos ha rechazado cada uno de nuestros clientes,
-- ordenado por el número total de rechazos.

select count(cod_pedido)
from pedidos
where estado='rechazado'
group by cod_cliente
order by count(cod_pedido) DESC;

-- 2.7. Consulta 7
-- Mostrar el importe total del pedido número 10.
select cod_pedido, sum(precio_unidad*cantidad)
from detalle_pedidos
where cod_pedido =10;

-- 2.8. Consulta 8
-- Obtener la máxima cantidad de un producto solicitada en un pedido siempre que ésta sea mayor o igual a 100.
-- Mostrar el resultado ordenado por la cantidad pedida.
select cod_producto, max(cantidad)
from detalle_pedidos
group by cod_producto
having max(cantidad) >=100
order by max(cantidad)ASC;

-- 2.9. Consulta 9
-- Mostrar el código del producto y el importe total pedido de cada producto cuyo importe total esté situado entre
-- los 800 y los 1000 euros, ordenado por el total obtenido.
select cod_producto, sum(precio_unidad*cantidad) as Importe_total
from detalle_pedidos;


-- 2.10. Consulta 10
-- Mostrar el código del producto y el importe total pedido de cada producto, de los productos con un precio mayor o igual a 50 euros y 
-- menor o igual a 100 y cuyo importe total esté situado entre los 800 y los 1000 euros, ordenado por el código del producto.

select cod_producto, sum(precio_unidad*cantidad)
from detalle_pedidos
where precio_unidad between 50 and 100
group by cod_producto
having sum(precio_unidad*cantidad) between 800 and 1000
order by 1;

-- 2.11. Consulta 11
-- Mostrar el código del cliente, su nombre y los números de los pedidos que han realizado 
-- los clientes del representante cuyo nombre es Emmanuel.

select c.cod_cliente, c.nom_cliente, p.cod_pedido, e.cod_empleado
from clientes c inner join pedidos p on c.cod_cliente = p.cod_cliente 
				inner join empleados e on e.cod_empleado = c.representante
where e.nombre = "Emmanuel";

-- 2.12. Consulta 12
-- Mostrar el nombre de los empleados y el número de pedidos realizados por todos sus clientes
-- ordenado de menor a mayor por el número de pedidos.
select e.nombre, e.cod_empleado, count(*)
from empleados e inner join clientes c on c.representante=e.cod_empleados
				 inner join pedidos p on p.cod_cliente = c.cod_cliente
group by e.cod_empleado, e.nombre, e.cod_empleado;

-- ejer 1 avanzado jardineria

-- mostrar el nombre de todos aquellos clientes (en una columna "Nombre Cliente")
-- que hayan hecho al menos un pedido, ordenado alfabéticamente
Select nom_cliente
from clientes
where cod_cliente in(select distinct cod_cliente
								from pedidos)
order by 1;
...
select p.cod_pedido, c.nom_cliente, dp.cod_pedido, p.cod_cliente
from clientes c, detalle_pedidos dp, pedidos p
where p.cod_pedido = dp.cod_pedido and 
p.cod_cliente = c.cod_cliente and
c.nom_cliente = "Beragua"
